...
## [3.16.0](https://github.com/romadryud/reatom/compare/async-v3.15.2...async-v3.16.0) (2024-08-10)


### Features

* **async:** add initState to errorAtom ([6852b72](https://github.com/romadryud/reatom/commit/6852b7291ccc4fb6acfb9ecfb48d3c2326fa78ee))
* **async:** add reatomAsyncReaction ([e44e641](https://github.com/romadryud/reatom/commit/e44e6417b5795c380e8c2e5dd1e576e7a6462bc0))
* **async:** add reset action to statusesAtom ([7803168](https://github.com/romadryud/reatom/commit/78031689792d7737641fc822324dbe482c4a8fec))
* **async:** add shouldPending and swrPendingAtom ([103e30c](https://github.com/romadryud/reatom/commit/103e30c7aa8bd7879da347d2653389a39221d952))
...
* **async:** activate resource on pending connection ([81f19b9](https://github.com/romadryud/reatom/commit/81f19b996c0a2535b2c9056dd4197f447620604f))
...
* **async:** allow empty deps for reatomResource ([47c9a2e](https://github.com/romadryud/reatom/commit/47c9a2e4350522ca39af3c5c4cf848a1ad5f967a))
* **async:** allow optional resetTrigger for withErrorAtom ([185f99d](https://github.com/romadryud/reatom/commit/185f99db81541ad72c18b5360517a89a08386807))
...
* **async:** dataAtom should be computed first ([8aab299](https://github.com/romadryud/reatom/commit/8aab299916f35afc0cb89983c58eeb4ae5b237cb))
...
* **async:** errorAtom: AtomMut ([a1349a8](https://github.com/romadryud/reatom/commit/a1349a8118366a75d4cb9bf40d6e94274a2a87f2))
* **async:** improve withStatusesAtom update order ([316bac5](https://github.com/romadryud/reatom/commit/316bac55d18cdd24c743e3e6e6eb5645b2ebf5c6))
* **async:** more mem safety for abortCauseContext ([aa5e29f](https://github.com/romadryud/reatom/commit/aa5e29f17d250a20a10476cb2054897feda43628))
* **async:** prevent ERR_UNHANDLED_REJECTION if the onReject has any handlers ([c66ad56](https://github.com/romadryud/reatom/commit/c66ad56e9b4cd536fda93e9cf0cc4a4b862abf91))
* **async:** prevent unhandled error for abort ([8c64522](https://github.com/romadryud/reatom/commit/8c64522bed4d13b35a9f7f354ef6b086b5fbda98))
...
* **async:** reatomResource small mem leak ([408d916](https://github.com/romadryud/reatom/commit/408d9167712cf53dc4381caee3c08f353752d990))
* **async:** reatomResource: do not drop the cache of an error ([75f54e6](https://github.com/romadryud/reatom/commit/75f54e6fe8ab5a46d20846656d908c0779551e81))
* **async:** retry abort ([7722626](https://github.com/romadryud/reatom/commit/7722626effd408f81a6a1864ce12faa43a617581))
* **async:** use abortCauseContext ([6133f27](https://github.com/romadryud/reatom/commit/6133f275d4cb3529fd744558324e38a621cb66a4))
...
* **async:** withAbort + withRetry ([d5190ab](https://github.com/romadryud/reatom/commit/d5190ab87d57e3925652e07c0741c2938b80cd39))
* **async:** withErrorAtom should be computed first ([0c458da](https://github.com/romadryud/reatom/commit/0c458da9f1eaf6a3226ca2e57f8ba5360dc7ce9e))
* **async:** withRetry races ([0abe299](https://github.com/romadryud/reatom/commit/0abe29976c319525544efd5fd659e004b76d6edf))
